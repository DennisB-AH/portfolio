...
## 1. Welcome to my personal portfolio repository

This repository contains the source code for my personal portfolio website, built using modern web technologies. Here, you can find information about my projects, skills, and contact details.

---
## Table of Contents
<!-- TOC -->
* [Portfolio](#portfolio)
  * [1. Welcome to my personal portfolio repository](#1-welcome-to-my-personal-portfolio-repository)
...
```sh
# HTTPS
git clone https://github.com/DennisB-AH/portfolio.git
